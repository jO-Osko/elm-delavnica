...
var $author$project$App$Increase = {$: 'Increase'};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Hello world: ' + $elm$core$String$fromInt(model))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$App$Increase)
							]))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$App$Decrease)
							]))
					]),
				_List_fromArray(
					[
...
var $author$project$App$main = $elm$browser$Browser$element(
	{
		init: $author$project$App$initialize,
...
_Platform_export({'App':{'init':$author$project$App$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"App.Msg","aliases":{},"unions":{"App.Msg":{"args":[],"tags":{"Increase":[],"Decrease":[]}}}}})}});}(this));